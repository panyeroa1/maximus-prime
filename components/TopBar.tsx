...
import { CCIcon, SpeakerWaveIcon, PhoneIcon, ChatBubbleLeftEllipsisIcon } from './icons';
...
export const TopBar: React.FC<TopBarProps> = ({ onToggleCaptions, isCaptionsOn, onNavigateToDialer, onOpenFeedback }) => {
  return (
